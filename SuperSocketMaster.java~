...
public class SuperSocketMaster implements Runnable {
    ...
    if (blnServerMode == true) {
      ...
      while (true) {
        ...
        try {
          ...
          SuperSocketListen singleconnection = new SuperSocketListen(inTextField, outBuffer, inBuffer, socketObject.toString(), this, strClientIP, strClientHostname);
  ...
  public class SuperSocketListen implements Runnable {
   ...
   public String strClientHostname = "";
    ...
    public SuperSocketListen(JTextField incomingTxt, PrintWriter outgoing, BufferedReader incoming, String strConn, SuperSocketMaster ssm, String strClientIP, String strClientHostname) {
      inTxt = incomingTxt;
      out = outgoing;
      in = incoming;
